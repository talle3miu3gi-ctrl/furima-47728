class PurchasedAddress
  ...
  def save
    ...
    Address.create(zip_code: zip_code, prefecture_id: prefecture_id, city: city, addresses: addresses, building: building,
                   phone_number: phone_number, purchased_id: purchased.id)
  end
end
