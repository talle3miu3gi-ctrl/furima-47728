...
ActiveRecord::Schema[7.1].define(version: 2026_04_23_065913) do
  ...
  create_table "addresses", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.index ["purchased_id"], name: "index_addresses_on_purchased_id"
  end
  ...
  create_table "purchaseds", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "user_id", null: false
  ...
  add_foreign_key "addresses", "purchaseds"
